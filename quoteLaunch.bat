...
set "pth=Q:\CUSTOMER\%customerfolder%\2023 Quotes\"

::search directory using quote number as a wildcard
for /f "delims=" %%a in ('dir /b /ad /on "\\sts2.local\DFS\Quotes\CUSTOMER\%customerfolder%\2023 Quotes\%varnum%*"') do set quotefolder=%%a


::Set auto completed path
set "pth=Q:\CUSTOMER\%customerfolder%\2023 Quotes\%quotefolder%\"
